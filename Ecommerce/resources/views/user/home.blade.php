                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        {{-- <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('products') }}">All Club</a></li>
                                <li><a class="dropdown-item" href="{{ route('players.club', ['Club' => 'Manchester United']) }}">Manchester United</a></li>
                                <li><a class="dropdown-item" href="{{ route('players.club', ['Club' => 'Al Nassr']) }}">Al Nassr</a></li>
                                <li><a class="dropdown-item" href="{{ route('players.club', ['Club' => 'Real Madrid']) }}">Real Madrid</a></li>
                                <!-- Tambahkan klub lain sesuai kebutuhan -->
                            </ul>
                        </li> --}}
                        {{-- <li class="nav-item">
